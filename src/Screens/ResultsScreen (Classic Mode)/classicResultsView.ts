...
export class ResultsView {
    ...
    constructor(stage: Konva.Stage) {
        ...
        Konva.Image.fromURL("/Humble Gift - Paper UI System v1.1/Sprites/Book Desk/desk image.jpg", (backgroundImage) => {
            ...
            Konva.Image.fromURL("/Humble Gift - Paper UI System v1.1/confetti.png", (confetti) => {
                confetti.x(0);
                confetti.y(0);
                confetti.width(this.stage.width());
                confetti.height(this.stage.height());
                this.layer.add(confetti);
                this.layer.draw();
            ...
            this.layer.draw();
                ...
                const completionText = new Konva.Text({
                    ...
                    text: 'Congratulations for achieving an \nimpressive score in classic mode!\n\nCan you beat your own record?',
                    fontSize: 38,
